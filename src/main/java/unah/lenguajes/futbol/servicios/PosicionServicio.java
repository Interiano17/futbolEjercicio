        ...
        for (int i = 0; i < numeroEquipos; i++) {
            for (int k = 0; k < numeroEquipos; k++) {
                if(i != k){
                    ...
                    long golesPrimerEquipoAcumContra = equipos.get(i).getGolesContra() + golesSegundoEquipo;
                    long golesSegundoEquipoAcumContra = equipos.get(k).getGolesContra() + golesPrimerEquipo;

                    equipos.get(i).setGolesContra(golesPrimerEquipoAcumContra);
                    equipos.get(k).setGolesContra(golesSegundoEquipoAcumContra);
                    ...
                    if(golesPrimerEquipo == golesSegundoEquipo){
                        ...
                        long empates1 = equipos.get(i).getEmpates();
                        empates1++;
                        equipos.get(i).setEmpates(empates1);
                       
                        long empates2 = equipos.get(k).getEmpates();
                        empates2++;
                        equipos.get(k).setEmpates(empates2);
